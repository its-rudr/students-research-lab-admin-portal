...
async function checkData() {
  ...
  if (error) {
    ...
    console.log("Sample records from debate_scores:", JSON.stringify(scores, null, 2));
  }
  ...
  if (sError) {
    ...
    console.log("Sample student enrollment numbers:", JSON.stringify(students, null, 2));
  }
}
